...
class ProcurementFeedback extends Component {
  constructor(props) {
    super(...arguments);
    this.state = {
      feedbackId: 0,
  ...
  render() {
    return (
      <div>
        <Header as="h2">
          <Image circular src={feedBack_icon} /> Procurement Feedback
        </Header>
        <div style={{ margin: "20px" }}>
          <Button.Group widths="1">
            ...
            >
              {" "}
              Add a new Procurement Feedback{" "}
            </Button>
          </Button.Group>
        </div>
        <div id="table1">
...
export default ProcurementFeedback;
