...
class DecisionSupportFeedback extends Component {
  constructor(props) {
    super(...arguments);
    this.state = {
      feedbackId: 0,
  ...
  render() {
    return (
      <div>
        <Header as="h2">
          <Image circular src={feedBack_icon} /> Decision Support Feedback
        </Header>
        <div style={{ margin: "20px" }}>
          <Button.Group widths="1">
            ...
            >
              {" "}
              Add a new Decision Support Feedback{" "}
            </Button>
          </Button.Group>
        </div>
        <div id="table1">
        ...
        <div id="add_feedBack">
          <Form>
            <Divider horizontal>
              <Header as="h4">
                <Icon name="sign-in" />
                Decision Support Feedback Addition
              </Header>
            </Divider>
            <Table definition>
              <Table.Body>
...
export default DecisionSupportFeedback;
